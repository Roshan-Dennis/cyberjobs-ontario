/**
 * Ontario places and economic regions.
 *
 * Data only. The matcher that turns a free-text location string into a place
 * lives in `canada.ts`, which composes this list with the other provinces.
 */
